...
export const counterSlice = createSlice({
  ...
  reducers: {
    ...
    addNewCounter: (state, action) => {
      ...
      const date = new Date().getTime() + 120 * 1000;
      state.counters[newCounterId] = { time: date, counting: true };
    },

    clearCounter: (state, action) => {
      const counterId = action.payload.ID;
      state.counters[counterId] = { time: 0, counting: false };
    },
...
// export const totalSeconds = (state) => state.counter.value;
